...
#' @usage make_DEgene_dotplot_pseudobulk(genes_oi, celltype_info, abundance_data, celltype_oi)
#'
...
#' @export
#'
make_DEgene_dotplot_pseudobulk = function(genes_oi, celltype_info, abundance_data, celltype_oi){
...
#' @usage make_DEgene_dotplot_pseudobulk_reversed(genes_oi, celltype_info, abundance_data, celltype_oi)
#'
...
#' @export
#'
make_DEgene_dotplot_pseudobulk_reversed = function(genes_oi, celltype_info, abundance_data, celltype_oi){
...
#' @usage make_DEgene_violin_plot(sce, gene_oi, celltype_oi, group_id, sample_id, celltype_id, covariate_oi = NA)
#'
...
#' @export
#'
make_DEgene_violin_plot = function(sce, gene_oi, celltype_oi, group_id, sample_id, celltype_id, covariate_oi = NA){
  requireNamespace("dplyr")
  requireNamespace("ggplot2")
